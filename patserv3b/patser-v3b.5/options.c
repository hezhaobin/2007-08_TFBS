...
double L_thresh;       /* Lower theshold for printing scores, inclusive. */
double U_thresh;       /* Upper theshold for printing scores, exclusive. */
char Top = NO;	       /* Just print top score for each sequence. */
